...
logs = [
    'trf_sa/trf_sa100_featg3_L2reg1.00e-05',
    'trf_sa/trf_sa100_featg3_L2reg1.00e-05_var',
    'trf_nce/trf_nce10_featg3_noise2gram',
    'trf_nce/trf_nce10_e200_cnn_(1to10)x200_(3x200)x3_relu_noise2gram',
    'trf_nce/trf_nce20_featg3_e200_cnn_(1to10)x200_(3x200)x3_relu_noise2gram',
    ]
baseline_name = ['KN3_000', 'lstm_e200_h200x2']
colors = ['r', 'g', 'b', 'k', 'c', 'y']
