...
if __name__ == '__main__':
    ...
    data = seq.DataX(total_level=2,
                     train_list=[pku_train],
                     valid_list=[pku_valid],
                     test_list=[pku_test]
                     )
    pku_vocab_chr = os.path.join(root_dir, 'vocab.chr')
    pku_vocab_pos = os.path.join(root_dir, 'vocab.pos')
    data.vocabs[0].write(pku_vocab_chr)
    data.vocabs[1].write(pku_vocab_pos)
    ...
    infos = {'pku_train': [pku_train],
             'pku_valid': [pku_valid],
             'pku_test': [pku_test],
             'pku_vocab_chr': pku_vocab_chr,
             'pku_vocab_pos': pku_vocab_pos,
