...
logs = [
    ...
    # 'trf_nce/trf_nce_noise1_data0_e200_cnn_(1to10)x128_(3x128)x3_blstm_128x1_at_logzlinear_LSTMGen_sv',  # mix

    # using LSTM generating, 1 noise, 1 data
    # 'trf_nce/trf_nce1_e256_cnn_(1to10)x128_(3x128)x3_logzmultiple_LSTMGen_HalfLSTMGenTrain',
    'trf_nce/trf_nce_noise1_data1_e256_cnn_(1to10)x128_(3x128)x3_logzlinear_LSTMGen',
